                ...
                <tbody>
                  <tr v-for="item in cart.items" :key="item.id">
                    ...
                    <td class="product-quantity" data-title="Quantity">
                      <div class="quantity">
                        <input
                          ...
                          class="minus"
                          @click="
                            cart.decrement(item), cart.updateQuantity(item)
                          "
                        />
                        <input
                          type="text"
                          ...
                          title="Qty"
                          @change="cart.updateQuantity(item)"
                          class="qty"
                          size="4"
                        />
                        <input
                          ...
                          class="plus"
                          @click="
                            cart.increment(item), cart.updateQuantity(item)
                          "
                        />
                      </div>
                    </td>
                    ...
                    <td class="product-remove" data-title="Remove">
                      <a href="#" @click.prevent="cart.removeFromCart(item)"
                        ><i class="ti-close"></i
                      ></a>
                    </td>
                  </tr>
                          ...
                          <div class="coupon field_form input-group">
                            ...
                            <div class="input-group-append">
                              <button
                                ...
                                type="button"
                                @click.prevent="cart.applyDiscount(couponCode)"
                              >
                                Apply Coupon
                              </button>
                            </div>
