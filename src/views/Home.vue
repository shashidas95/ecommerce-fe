                      ...
                      <div class="product_img">
                        ...
                        <div class="product_action_box">
                          <ul class="list_none pr_action_btn">
                            ...
                            <li>
                              <a
                                @click.prevent="wishlist.addToWishlist(product)"
                                href="#"
                      ...
                      <div class="product_info">
                        ...
                        <div class="product_price">
                          ...
                          <div
                            ...
                            class="variations mb-2"
                          >
                            <!-- Size buttons -->
                            <div class="sizes mb-1">
                        ...
                        <div class="rating_wrap">
                          <div class="rating">
                            <div
                              class="product_rate"
                              :style="{ width: (product.star / 5) * 100 + '%' }"
                            >
                              {{ product.star }}
                            </div>
                          </div>
...
onMounted(async () => {
  try {
    ...
    // Explanation: res.data → outer object, .data → pagination object, .data → actual products array
  } catch (err) {
...
//   const variationId = selectedVariations[product.id] || null
